...
AWCG to modyfikacja LCG dodająca bit przeniesienia (_carry_), co poprawia statystyczne własności. Wzór: $x_{n+1} = (a x_n + c + \text{carry}_n) \bmod m$.
...
- Wariant rodziny generatorów _with-carry_ (Marsaglia i Zaman, lata 90.).
